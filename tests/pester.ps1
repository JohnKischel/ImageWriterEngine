...
Remove-Module ImageWriterEngine -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ImageWriterEngine.psd1"
Import-Module "$PSScriptRoot\..\ImageWriterEngine.psm1" -Force
